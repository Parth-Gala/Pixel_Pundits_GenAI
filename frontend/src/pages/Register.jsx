...
const Register = () => {
  ...
  const handleChange = (e) => {
    if (e.target.id === "goalType") {
      setCredentials((prev) => ({
        ...prev,
        goals: { ...prev.goals, [e.target.id]: e.target.value },
      }));
    }
    if (e.target.id === "activityLevel") {
      setCredentials((prev) => ({
        ...prev,
        ...
        <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 ">
          ...
          <div className="mt-3 w-full">
            ...
            <div className="mt-2 relative">
              ...
              id="activityLevel"
              >
                <option value="" id="activityLevel">Select Activity Level</option>
                <option value="Sedentary" id="activityLevel" >Sedentary</option>
                <option value="Lightly Active" id="activityLevel">Lightly Active</option>
                <option value="Moderately Active" id="activityLevel">Moderately Active</option>
                <option value="Very Active" id="activityLevel">Very Active</option>
                <option value="Extra Active" id="activityLevel">Extra Active</option>
              </select>
          ...
          <div className="mt-3 w-full">
            ...
            <div className="mt-2 relative">
              <select
                ...
                id="goalType" // Added ID for handleChange
